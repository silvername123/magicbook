// 管理actions
const actions = {
  // commit调用mutations return data
  setFileName: ({ commit }, fileName) => {
    // console.log('test = ' + state.test, fileName)
  ...
  setBookcfi({ commit }, bookCfi) {
    return commit('SET_BOOKCFI', bookCfi)
  },
  addBookcfi({ commit }) {
    return commit('ADD_BOOKCFI')
  },
  setBookLength({ commit }, bookLength) {
    return commit('SET_BOOKLENGTH', bookLength)
  },
