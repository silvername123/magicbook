      ...
      <div class="book-detail-content-wrapper">
        ...
        <div class="book-detail-content-list-wrapper">
          ...
          <div class="book-detail-content-row">
            ...
            <div class="book-detail-content-text">冒险</div>
          </div>
          <div class="book-detail-content-row">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      downloadBook() {
        const opf = `${process.env.VUE_APP_EPUB_URL}/${this.bookItem.categoryText}/${this.bookItem.fileName}/vol.opf`
        // console.log(opf)
        this.parseBook(opf)
      },
      parseBook(url) {
        ...
        this.book.loaded.navigation.then(nav => {
          ...
          if (this.navigation.toc && this.navigation.toc.length > 1) {
            const candisplay = this.display(this.book)
            if (candisplay) {
